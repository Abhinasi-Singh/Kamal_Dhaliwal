          ...
          formStatus.innerHTML = `
            <div class="status-content">
              ...
              <div>
                ...
                <p>Set Google Form credentials or Web3Forms key in script.js. In the meantime, <a href="mailto:kamal27d@gmail.com?subject=Zero Down Inquiry" style="color: inherit; text-decoration: underline;">click here to email Kamal directly</a>.</p>
              </div>
            </div>
          `;
        } else {
